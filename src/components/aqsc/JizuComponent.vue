<template>
  <el-tooltip :disabled="tooltipDisable" class="item" effect="dark" :content="tooltipContentStr" placement="top">
    <el-select v-model="svalue" :placeholder="spholder" filterable :clearable="clearable" :disabled="disabled"
...
export default {
  ...
  methods: {
    ...
    queryData(param) {
      const p = { is_del: 0, werks: this.werks, bukrs: this.bukrs, dyid: this.dyid };
